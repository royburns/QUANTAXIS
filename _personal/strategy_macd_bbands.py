...
code_list = QA.QA_fetch_stock_list_adv().code[0:50]
start_date = '2018-01-01'
end_date = '2018-05-23'


# define the MACD_BBANDS strategy
def MACD_BBANDS(dataframe, SHORT=12, LONG=26, M=9):
    """
    1.DIF向上突破DEA，买入信号参考。
    2.DIF向下跌破DEA，卖出信号参考。
    """
...
Account.account_cookie = 'user_admin_macd_bbands'
