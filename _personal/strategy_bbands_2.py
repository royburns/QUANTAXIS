...
class BollingerBandsStrategy(QA_Strategy):
    ...
    def on_bar(self, event):
        ...
        tomorrow_on_bar = pd.Timestamp(self.current_time.date().day - 1)
        print(today_on_bar)
        print(tomorrow_on_bar)
...
if __name__ == '__main__':
    time_to_Market_300439 = '2018-01-01'
    time_to_day = '2018-05-25'
    code_list = ['300439', '000001', '600000', '600426', '600637']
